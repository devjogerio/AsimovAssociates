...
def gerar_card_padrao(qnt_procs):
    card_padrao = dbc.Card([
        dbc.CardBody([
            dbc.Row([
                dbc.Col([
                    html.I(className='fa fa-search', style={'fontSize': '2rem', 'color': 'white', 'marginBottom': '10px'}),
                    html.H3(f"{qnt_procs} PROCESSOS ENCONTRADOS", style={'fontWeight': '600', 'color': 'white', 'marginBottom': '0'})
                ], className='text-center')
            ])
        ])
    ], style={'height': '100%', 'marginBottom': '20px', 'backgroundColor': 'var(--primary-color)', 'borderRadius': '12px', 'boxShadow': '0 4px 6px rgba(0, 0, 0, 0.1)'})
    return card_padrao
    ...
    card_processo = dbc.Card([
        dbc.CardBody([
            dbc.Row([
                ...
                ], sm=12, md=6, style={'borderRight': '2px solid lightgrey'}),
                dbc.Col([
                    dbc.Row([
                        dbc.Col([
                            html.Ul([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.H5("STATUS", style={'marginBottom': 0}),
                        ], sm=5, style={'textAlign': 'right'}),
                        dbc.Col([
                ...
                ], sm=12, md=6, style={'height': '100%', 'marginTop': 'auto', 'marginBottom': 'auto'}),
...
layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            html.Div([
                html.I(className='fa fa-balance-scale', style={'fontSize': '2rem', 'color': 'var(--primary-color)', 'marginRight': '15px'}),
                html.H3("ENCONTRE O PROCESSO QUE VOCÊ PROCURA", style={'color': 'var(--text-color)', 'fontWeight': '600', 'margin': '0'})
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                ...
                                dbc.Col([
                                    dbc.Button([html.I(className='fa fa-search')], id="pesquisar_num_proc", color='primary', className='btn-search')
                                ], sm=12, md=12, lg=4)
                            ], style={'marginBottom': '32px'}),
                            dbc.Row([
                                dbc.Col([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    dbc.Button([html.I(className='fa fa-search')], id="pesquisar_cpf", color='primary', className='btn-search')
                                ], sm=2),
                                dbc.Col([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    dbc.Button([html.I(className='fa fa-list', style={'marginRight': '10px'}), "Todos os Processos"], id="todos_processos", style={'width': '100%'}, color="primary", className='btn-action')
                                ])
                            ], style={'margin-top': '24px'})
                        ], style={'margin': '20px'})
                    ])
...
def generate_cards(n, n_all, adv_filter, proc_button, proc_data, adv_data, switches, checklist, proc_filter, cpf):
    ...
    if (trigg_id == '' or trigg_id == 'store_proc' or trigg_id == 'store_adv' or trigg_id == 'todos_processos' or trigg_id == 'switches_input' or trigg_id == 'checklist_input'):
        ...
        # Convertendo valores booleanos para texto após a filtragem
        df_proc_aux['Processo Concluído'] = df_proc_aux['Processo Concluído'].map({0: 'Não', 1: 'Sim'})
        df_proc_aux['Processo Vencido'] = df_proc_aux['Processo Vencido'].map({0: 'Não', 1: 'Sim'})
        ...
        if cpf in df_proc['Cpf Cliente'].values:
            ...
            card = dbc.Card([
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col([
                            html.I(className='fa fa-exclamation dbc', style={'fontSize': '4em'})
