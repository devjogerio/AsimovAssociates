...
layout = dbc.Modal(
    ...
    children=[
        dbc.ModalHeader(
            ...
            children=[
                dbc.ModalTitle([
                    html.I(className='fa fa-file-text', style={'marginRight': '10px'}),
        ...
        dbc.ModalBody(
            ...
            children=[
                ...
                dbc.Row([
                    dbc.Col([
                        html.H5([
                            html.I(className='fa fa-info-circle', style={'marginRight': '10px'}),
                ...
                dbc.Row([
                    dbc.Col([
                        html.H5([
                            html.I(className='fa fa-folder-open', style={'marginRight': '10px'}),
                            "Informações de Arquivo"
                        ], className='mb-4'),
                        # Empresa
                        dbc.Label([
                            html.I(className='fa fa-building', style={'marginRight': '8px'}),
                            'Empresa'
                        ], html_for='empresa_matriz'),
                        ...
                        # Tipo de Processo
                        dbc.Label([
                            html.I(className='fa fa-tag', style={'marginRight': '8px'}),
                            'Tipo de Processo'
                        ], html_for='tipo_processo'),
                        ...
                        # Ação
                        dbc.Label([
                            html.I(className='fa fa-gavel', style={'marginRight': '8px'}),
                            'Ação'
                        ], html_for='acao'),
                    ...
                    dbc.Col([
                        dbc.Label([
                            html.I(className='fa fa-file-text-o', style={'marginRight': '8px'}),
                            'Descrição'
                        ], html_for='input_desc'),
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Label([
                            html.I(className='fa fa-institution', style={'marginRight': '8px'}),
                            'Vara'
                        ], html_for='vara'),
                    ...
                    dbc.Col([
                        dbc.Label([
                            html.I(className='fa fa-clock-o', style={'marginRight': '8px'}),
                            'Fase'
                        ], html_for='fase'),
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([
                                html.H5([
                                    html.I(className='fa fa-users', style={'marginRight': '10px'}),
                                    "Informações do Cliente"
                                ], className='mb-4'),
                                dbc.Row([
                                    dbc.Col([
                                        dbc.Label([
                                            html.I(className='fa fa-calendar', style={'marginRight': '8px'}),
                        ...
                        html.Br(),
                        dbc.Switch(
                            id='processo_concluido',
                            label=[
                                html.I(className='fa fa-check-circle', style={'marginRight': '8px'}),
                                "Processo Concluído"
                            ],
                            value=False
                        ),
                        dbc.Switch(
                            id='processo_vencido',
                            label=[
                                html.I(className='fa fa-exclamation-circle', style={'marginRight': '8px'}),
                                "Processo Vencido"
                            ],
                            value=False
                        ),
                        html.P("O filtro de data final só será computado se o checklist estiver marcado.", className='dbc', style={'fontSize': '80%'})
                    ], sm=12, md=5),
                    dbc.Col([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label([
                                    html.I(className='fa fa-user', style={'marginRight': '8px'}),
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Label([
                                    html.I(className='fa fa-id-card', style={'marginRight': '8px'}),
                                    "CPF do Cliente"
                                ]),
                                dbc.Input(
                                    id="input_cliente_cpf",
                ...
                ], style={'backgroundColor': 'var(--background-color)', 'padding': '20px', 'borderRadius': '8px', 'marginBottom': '20px'}),
                dbc.Row([
                    dbc.Col([
                        dbc.Label([
                            html.I(className='fa fa-archive', style={'marginRight': '8px'}),
                            "Local de Arquivo"
                        ]),
                        dcc.Dropdown(
                            id='input_local_arquivo',
                            clearable=False,
                            className='dbc',
                    ...
                    dbc.Col([
                        dbc.Label([
                            html.I(className='fa fa-hashtag', style={'marginRight': '8px'}),
                            "Número do Processo"
                        ]),
                        dbc.Input(
                            id="input_no_processo",
        ...
        dbc.ModalFooter(
            ...
            children=[
                dbc.Button(
                    children=[
                        html.I(className='fa fa-times', style={'marginRight': '8px'}),
                        "Cancelar"
                    ],
                ...
                dbc.Button(
                    children=[
                        html.I(className='fa fa-check', style={'marginRight': '8px'}),
                        "Salvar"
                    ],
    ...
    if trigg_id == 'save_button_novo_processo':
        ...
        if len(df_int.index) == 0: # Novo processo
            if None in [no_processo, empresa, tipo, acao, vara, fase, instancia, data_inicial, advogados, cliente, cpf_cliente]:
                return store_proc, ["Todos dados são obrigatórios para registro!"], {'marginBottom': '15px', 'color': 'red'}, no_processo, empresa, tipo, acao, vara, fase, instancia, data_inicial, data_final, processo_concluido, processo_vencido, advogados, cliente, cpf_cliente, desc, False
            if (no_processo in df_proc['No Processo'].values):
                return store_proc, ["Número de processo ja existe no sistema!"], {'marginBottom': '15px', 'color': 'red'}, no_processo, empresa, tipo, acao, vara, fase, instancia, data_inicial, data_final, processo_concluido, processo_vencido, advogados, cliente, cpf_cliente, desc, False
            ...
            no_processo = empresa = tipo = acao = vara = fase = instancia = data_inicial = data_final = advogados = cliente = cpf_cliente = desc = None
            processo_concluido = processo_vencido = False
            return store_proc, ['Processo salvo com sucesso!'], {'marginBottom': '15px', 'color': 'green'}, no_processo, empresa, tipo, acao, vara, fase, instancia, data_inicial, data_final, processo_concluido, processo_vencido, advogados, cliente, cpf_cliente, desc, False
